...
class SiteTest extends WebTestCase
{
    ...
    public function test001VideoShowMessage(){
        $this->videoInit();
		$this->open('');
    ...
    public function test002VideoMouseClick(){
        $this->videoInit();
    ...
    public function test004VideoShowImage(){
        $this->videoInit();
        $this->open('');
        $this->videoStart(__FUNCTION__);
    ...
    public function test005VideoSetVisible(){
        $this->videoInit();
